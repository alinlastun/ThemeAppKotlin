...
import com.theme.junky.themeskotlin.databinding.WallpaperActivityBinding
import com.theme.junky.themeskotlin.screen.wallpapers.utils.WallpapersAdapter
import com.theme.junky.themeskotlin.screen.wallpapers.utils.setWallpapersAdapter
...
class Wallpapers : AppCompatActivity(), ListenerImage {
    ...
    private lateinit var mBinding: WallpaperActivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = DataBindingUtil.setContentView(this, com.theme.junky.themeskotlin.R.layout.wallpaper_activity)
    ...
    override fun whenClickOnImage(urlString: String,isClicked:Boolean,position:Int) {
       ...
       // (application as MainApplication).MGAE.getEvents(getString(R.string.layout_event),"MoreApps: Click on position: ${position} ${urlString}","Click on Button")
        ...
        nButtonSelectWall.background = ContextCompat.getDrawable(this, com.theme.junky.themeskotlin.R.drawable.select_button)
